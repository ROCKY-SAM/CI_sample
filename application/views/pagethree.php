...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">pagethree</li>
</ol>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form action="<?php echo site_url(); ?>/pageone/updateSampleDB" method="post">
            <div class="form-group row">
                <label for="usr" class="col-sm-2 col-form-label">Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="userName" required="" value="<?php echo $list->name?>">
                </div>
            </div> 
            <input type="text" class="form-control" name="id" required="" value="<?php echo $list->id?>" hidden="">
            <div class="form-group row">
                <label for="role" class="col-sm-2 col-form-label">Type</label>
                <div class="col-sm-10">
                    <select class="form-control" name="typeSelect" required value="<?php echo $list->type?>">
